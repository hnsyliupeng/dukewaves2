% Input File 'inp_frictionless_sliding_analyt_3_1053.m'
%
...
% Length x height = 8 x 8. radius a = 0.5. unstructured mesh. 1053
% elements.
%**************************************************************************
%
...
IFfilename_msh_file = 'stripewithhole';      % NO FILE EXTENSION '.msh'
%--------------------------------------------------------------------------
