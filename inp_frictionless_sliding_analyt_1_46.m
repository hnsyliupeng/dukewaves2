% Input File 'inp_frictionless_sliding_analyt_1_46.m'
%
...
% their stabilization. Rectangular domain. Length x height = 6 x 4. 46
% elements.
%**************************************************************************
%
...
IFfilename_msh_file = 'patchtest_46';      % NO FILE EXTENSION '.msh'
%--------------------------------------------------------------------------
