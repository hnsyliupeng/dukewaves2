% Input File 'inp_frictionless_sliding_analyt_2_552.m'
%
...
% Length x height = 5 x 2. 552 elements in an unstructured mesh.
%**************************************************************************
%
...
IFfilename_msh_file = 'rectangle_552';      % NO FILE EXTENSION '.msh'
%--------------------------------------------------------------------------
