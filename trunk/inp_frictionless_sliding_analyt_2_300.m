% Input File 'inp_frictionless_sliding_analyt_2_300.m'
%
...
% Length x height = 5 x 2. unstructured mesh. 300 elements. 
%**************************************************************************
%
...
IFfilename_msh_file = 'rectangle_300';      % NO FILE EXTENSION '.msh'
%--------------------------------------------------------------------------
