function [fex] = forcecutelem(node,e,B,x,y,z,xint,yint,zint,disp,numnod,ls,ifixu,nb_int,edge_id,volumep)
...
if (nb_int==3)
    ...
    if(wedgeflag==0)
        ...
        [fex] = fexttetsub(xe_sub,ye_sub,ze_sub,volume_sub,Amat);
    else
        ...
        [fex] = fextwedgesub(xe_sub,ye_sub,ze_sub,volume_sub,Amat);
    end
elseif(nb_int==4)
