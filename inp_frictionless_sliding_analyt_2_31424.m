% Input File 'inp_frictionless_sliding_analyt_2_31424.m'
%
...
% Length x height = 5 x 2. unstructured mesh. 31424 elements. 
%**************************************************************************
%
...
% via integration
IFboundarydescription = 'frictionless_sliding_analyt_2_72_18_BDes'; %NO FILE EXTENSION '.m'
%
% filename of msh-file withput file extension '.msh'
% (if reading mesh from gmsh-msh-file)
IFfilename_msh_file = 'analyt_2_31424';      % NO FILE EXTENSION '.msh'
%--------------------------------------------------------------------------
