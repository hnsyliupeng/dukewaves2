% Input File 'inp_frictionless_sliding_analyt_8_420.m'
%
...
% domain. Length x height = 16 x 4. unstructured mesh. 420 elements.
%**************************************************************************
%
...
IFfilename_msh_file = 'patchtest_420';      % NO FILE EXTENSION '.msh'
%--------------------------------------------------------------------------
